...
using RealbnbBeta.Areas.Identity;
using RealbnbBeta.Data;
using RealbnbBeta.Service;

namespace RealbnbBeta
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            /**/
            var sqlConnectionConfiguration = new SqlConnectionConfiguration(Configuration.GetConnectionString("DefaulConnection"));
